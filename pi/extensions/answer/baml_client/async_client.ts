...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ExtractionResult> {
          try {
          ...
          const __stream__ = this.stream.ExtractQuestions(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ExtractionResult
            } catch (error) {
            ...
            input: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ExtractionResult, types.ExtractionResult>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ExtractQuestions", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ExtractionResult, types.ExtractionResult>(
                  __raw__,
                  (a): partial_types.ExtractionResult => a,
                  (a): types.ExtractionResult => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
