...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async ExtractRenderDoc(
        input: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.RenderDoc> {
          try {
          ...
          const __stream__ = this.stream.ExtractRenderDoc(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.RenderDoc
            } catch (error) {
            ...
            input: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.RenderDoc, types.RenderDoc>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ExtractRenderDoc", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.RenderDoc, types.RenderDoc>(
                  __raw__,
                  (a): partial_types.RenderDoc => a,
                  (a): types.RenderDoc => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
